...
async function syncGroupmaker() {
  ...
  const usingElectronCallWindow = Boolean(window.lifelineElectron?.openKindroidCall);
  const preparedTab = usingElectronCallWindow ? null : window.open('about:blank', '_blank');
